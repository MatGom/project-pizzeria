...

{
  ...
  class Product {
    ...
    initAccordion() {
      ...
      thisProduct.accordionTrigger.addEventListener('click', function (event) {
        ...
        /* if these is active product and it's not thisProduct.element, remove class active from it*/
    ...
    processOrder() {
      ...
      // uptade calculated price in the HTML
  ...
  class AmountWidget {
    constructor(element) {
      ...
      thisWidget.initActions(thisWidget.value); // do sprawdzenia thisWidget.value
    }
    ...
    initData: function () {
      ...
      fetch(url)
        ...
        .then(function (parsedResponce) {
          ...
          /* save parsedResponce as thisApp.data.products */
